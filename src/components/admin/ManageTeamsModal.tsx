  ...
  return (
    <div
      className={`flex h-5 w-5 shrink-0 items-center justify-center rounded-md border transition ${
        checked
          ? 'border-purple-400/70 bg-brand-gradient-br'
          ...
          <div className="overflow-hidden rounded-xl border border-line bg-card">
                      ...
                      <li key={t.id}>
                        <button
                          ...
                          className={`flex w-full items-start gap-3 px-4 py-3 text-left transition ${
                            isSelected ? 'bg-brand-soft' : 'hover:bg-fill-2'
                          }`}
                        >
            ...
            {isAdmin && (
              <button
                ...
                className="flex w-full items-center gap-2 border-t border-line bg-fill-1 px-4 py-3 text-sm font-medium text-brand transition hover:bg-fill-2 hover:text-brand"
              >
